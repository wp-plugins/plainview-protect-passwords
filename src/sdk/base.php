...
namespace plainview\sdk_propas;
...
class base
{
	...
	**/
	...
	{
		if ( ! function_exists( '\\plainview\\sdk_propas\\thirdparty\\wordpress\\add_query_arg' ) )
			require_once( __DIR__ . '/thirdparty/wordpress/functions.php' );
		return call_user_func_array( '\\plainview\\sdk_propas\\thirdparty\\wordpress\\add_query_arg', func_get_args() );
	}
	...
	**/
	...
	/**
		...
		@return		\\plainview\\sdk_propas\\form2\\form		A new form object.
		@since		20130509
	**/
	public function form2()
	{
		if ( ! class_exists( '\\plainview\\sdk_propas\\form2\\form' ) )
			require_once( dirname( __FILE__ ) . '/form2/form.php' );

		if ( ! class_exists( '\\plainview\\sdk_propas\\wordpress\\form2\\form' ) )
			require_once( 'form2.php' );

		$form = new \plainview\sdk_propas\wordpress\form2\form();
		return $form;
	}
	...
	**/
	...
	{
		$options = \plainview\sdk_propas\base::merge_objects( [
			'time' => date( 'U' ),
			'text_day' => '1 day',
			'text_days' => '%d days',
			'text_hour' => '1 hour',
	...
	**/
	...
	/**
		...
		@return		\\plainview\\sdk_propas\\mail\\mail		A new PHPmailer object.
		@since		20130430
	**/
	public static function mail()
	{
		$mail = new \plainview\sdk_propas\mail\mail();
		$mail->CharSet = 'UTF-8';
		return $mail;
	}
	...
	**/
	...
	{
		if ( ! function_exists( '\\plainview\\sdk_propas\\thirdparty\\thirdparty\wordpress\\remove_query_arg' ) )
			require_once( __DIR__ . '/thirdparty/wordpress/functions.php' );
		return call_user_func_array( '\\plainview\\sdk_propas\\thirdparty\\wordpress\\remove_query_arg', func_get_args() );
	}
