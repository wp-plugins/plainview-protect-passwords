...
namespace plainview\sdk_propas\wordpress;

class base
	extends \plainview\sdk_propas\base
{
	/**
	...
	**/
	public function __construct( $__FILE__ = null )
	{
		...
		$this->submenu_pages = new \plainview\sdk_propas\collections\collection;
	...
	**/
	...
	/**
		...
		@param		array		$inputs		Array of \\plainview\\sdk_propas\\wordpress\\form inputs.
		@param		array		$options	Array of options.
		@since		20130416
	**/
	public function display_form_table( $inputs, $options = array() )
	{
		$options = \plainview\sdk_propas\base::merge_objects( array(
			'form' => null,
			'header' => '',
			'header_level' => 'h3',
		), $options );
...
**/
	...
	**/
	...
	/**
		...
		@return		object					A new \\plainview\\sdk_propas\\wordpress\\form object.
		@since		20130416
	**/
	public function form( $options = array())
	{
		...
		return new \plainview\sdk_propas\wordpress\form( $options );
	}
	...
	**/
	...
	{
		$form = new \plainview\sdk_propas\wordpress\form2\form( $this );
		return $form;
	}
	...
	**/
	...
	/**
		...
		@return		object		A new \\plainview\\sdk_propas\\wordpress\\table object.
		@since		20130416
	**/
	public function table()
	{
		$table = new \plainview\sdk_propas\wordpress\table\table( $this );
	...
	**/
	public function tabs( $options = array() )
	{
		if ( count( $options ) == 0 )
		{
			$tabs = new \plainview\sdk_propas\wordpress\tabs\tabs( $this );
			return $tabs;
		}
