...
namespace plainview\sdk_propas\wordpress\plugin_pack;
...
**/
class plugin
	extends \plainview\sdk_propas\collections\collection
{
	/**
		@brief		Constructor.
	...
	**/
	public function load()
	{
		...
		if ( $reflection->isSubClassOf( '\\plainview\\sdk_propas\\wordpress\\base' ) )
