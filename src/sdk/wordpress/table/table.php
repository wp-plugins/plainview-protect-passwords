...
namespace plainview\sdk_propas\wordpress\table;
...
**/
class table
	extends \plainview\sdk_propas\table\table
{
	use \plainview\sdk_propas\traits\method_chaining;

	/**
		@brief		The \\plainview\\sdk_propas\\table\\wordpress\\base object that created this class.
	**/
	public $base;
