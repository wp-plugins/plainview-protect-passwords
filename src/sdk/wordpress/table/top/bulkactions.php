...
namespace plainview\sdk_propas\wordpress\table\top;

use \plainview\sdk_propas\collections\collection;
...
class bulkactions
{
	...
	**/
	public function cb( $row, $id = null )
	{
		...
		if ( $section == 'plainview\\sdk_propas\\table\\head' )
		{
		...
		if ( $section == 'plainview\\sdk_propas\\table\\body' )
		{
