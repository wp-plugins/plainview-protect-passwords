...
namespace plainview\sdk_propas\pagination;

use \plainview\sdk_propas\base;
use \plainview\sdk_propas\html\div;
...
/**
	...
	$p = new \plainview\sdk_propas\pagination\pagination;
	$p->page( 77 )
		->pages( 186 )
...
class pagination
{
	...
	use \plainview\sdk_propas\traits\method_chaining;
