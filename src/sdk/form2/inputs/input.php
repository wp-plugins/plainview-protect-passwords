...
namespace plainview\sdk_propas\form2\inputs;
...
class input
{
	use \plainview\sdk_propas\html\element;
	use \plainview\sdk_propas\html\indentation;
	...
	**/
	...
	{
		$random = \plainview\sdk_propas\base::uuid();
	...
	**/
	public function display_input()
	{
		...
		if ( $input->form()->post_is_set() )
		{
			...
			if ( $value != '' )
			{
				$value = \plainview\sdk_propas\form2\form::unfilter_text( $value );
				$input->value( $value );
			}
			else
	...
	**/
	...
	{
		$r = new \plainview\sdk_propas\html\div();
	...
	**/
	public function make_id()
	{
		if ( $this->has_attribute( 'id' ) )
			return $this->get_attribute( 'id' );
		$id = $this->make_name();
		$id = \plainview\sdk_propas\base::strtolower( $id );
	...
	**/
	...
	{
		$title = \plainview\sdk_propas\form2\form::filter_text( $title );
