	...
	extends input
{
	...
	**/
	public function _construct()
	{
		if ( $this->get_attribute( 'name' ) == '' )
			$this->set_attribute( 'name', \plainview\sdk_propas\base::uuid( 4 ) );
	}

	public function __toString()
	{
		return \plainview\sdk_propas\form2\form::unfilter_text( $this->get_value() );
	}
	...
	**/
	...
	{
		return $this->markup( \plainview\sdk_propas\base::wpautop( $markup ) );
	}
